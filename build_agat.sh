...
export INITRAMFS_SOURCE="${KERNELDIR}/../ramdisk-l710-jb-4.3"
...
#
export ARCH=arm
CROSS_COMPILE=/home/jdsingle76/S3Kernel/kernel-extras/arm-eabi-4.6/bin/arm-eabi-
...
## Build zImage
nice -n 10 make -j8 CC="ccache /home/jdsingle76/S3Kernel/kernel-extras/arm-eabi-4.6/bin/arm-eabi-gcc" zImage 2>&1 | tee compile-zImage.log
...
## Build Modules
nice -n 10 make -j8 CC="ccache /home/jdsingle76/S3Kernel/kernel-extras/arm-eabi-4.6/bin/arm-eabi-gcc" modules 2>&1 | tee compile-modules.log
